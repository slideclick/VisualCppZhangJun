...
NewFileInclude2=#include "MfcMdi.h"
LastPage=0
...
Resource3=IDR_MFCMDITYPE

[CLS:CMfcMdiApp]
Type=0
HeaderFile=MfcMdi.h
ImplementationFile=MfcMdi.cpp
Filter=N

[CLS:CMfcMdiDoc]
Type=0
HeaderFile=MfcMdiDoc.h
ImplementationFile=MfcMdiDoc.cpp
Filter=N

[CLS:CMfcMdiView]
Type=0
HeaderFile=MfcMdiView.h
ImplementationFile=MfcMdiView.cpp
Filter=C
